...
@section('content')
    <div class="container-fluid px-4">
        ...
        <a class="btn btn-primary btnAdd" href="{{route('admin.products.create')}}">Tạo mới</a>
        <div class="card mb-4">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                    ...
                    <tr style="text-transform: none !important;" class="text-start text-muted fw-bolder fs-7 gs-0">
                        ...
                        <th style="text-align: center;text-transform: none !important;" class="min-w-125px">Chức năng</th>
                    </tr>
                    <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
