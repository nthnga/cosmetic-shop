...
@section('content')
    ...
    <form id="" class="form" action="{{route('admin.categories.update',$category->id)}}" method="post" style="width: 96%!important; margin: 2%" enctype="multipart/form-data">
        @csrf
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10" style="margin-top: 10px">
                ...
                <div class="card-body pt-0 row">
                    <div class="col-sm-6">
                        <div class="mb-10 fv-row">
                            <label class="form-label">Tên danh mục:</label><span style="color: red;"> *</span>
                            <input type="text" name="name" class="form-control mb-2" placeholder="Nhập tên..." value="@if(!empty(old("name"))){{old("name")}}@else {{$category->name}}@endif" />
                            @error('name')
                        ...
                        <div class="mb-10">
                            ...
                            <textarea class="form-control mb-2" style="width:100%;" name="description" id="" rows="4" placeholder="Nhập mô tả..." >@if(!empty(old("description"))){{old("description")}}@else {{$category->description}}@endif</textarea>
                            @error('description')
                            <div style="color: red;" class="">{{$message}}</div>
                            @enderror
                        </div>
            ...
            <div class="d-flex justify-content-end" style="margin-top: 20px">
                <a href="{{route('admin.categories.index')}}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-3">Huỷ</a>
