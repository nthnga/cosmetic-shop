...
@section('content')
    ...
    <form id="" class="form" action="{{route('admin.categories.store')}}" method="post" style="width: 96%!important; margin: 2%" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="mb-10">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" accept=".png, .jpg, .jpeg" class="custom-file-input" id="listImg" name="image" required>
                                </div>
                            </div>
                            <style>
                                .gallery > img {
