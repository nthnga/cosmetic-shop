...
@section('content')
    <div class="container-fluid px-4">
        ...
        <a class="btn btn-primary btnAdd" href="{{route('admin.categories.create')}}">Tạo mới</a>
        <div class="card mb-4">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
                    ...
                    <tr style="text-transform: none !important;" class="text-start text-muted fw-bolder fs-7 gs-0">
                        ...
                        <th style="text-transform: none !important;" class="min-w-125px">Tên danh mục</th>
