<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <h5 class="text-secondary text-uppercase mb-4">Về phía chúng tôi</h5>
            <p class="mb-4">Hãy tin tưởng vào sự lựa chon của các bạn dành cho chúng tôi. Luôn mang tới những sản phẩm tốt nhất</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Long Biên - Hà Nội</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>cometicshop123@gmail.com</p>
